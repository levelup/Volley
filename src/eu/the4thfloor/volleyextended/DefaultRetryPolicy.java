...
public class DefaultRetryPolicy implements RetryPolicy {
   ...
   */
  public DefaultRetryPolicy(final int initialTimeoutMs, final int maxNumRetries, final float backoffMultiplier) {
  ...
  public void retry(final VolleyError error) throws VolleyError {
    ...
    this.mCurrentTimeoutMs += (this.mCurrentTimeoutMs * this.mBackoffMultiplier);
