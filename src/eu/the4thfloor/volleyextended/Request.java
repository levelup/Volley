...
import eu.the4thfloor.volleyextended.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
  ...
  private final Response.ErrorListener<T> mErrorListener;
   ...
   * 
   * @deprecated Use {@link #Request(int, String, eu.the4thfloor.volleyextended.Response.ErrorListener)}.
   */
  @Deprecated
  public Request(final String url, final Response.ErrorListener<T> listener) {
   ...
   */
  public Request(final int method, final String url, final Response.ErrorListener<T> listener) {
  ...
  void finish(final String tag) {
    ...
    if (MarkerLog.ENABLED) {
      ...
      final long requestTime = SystemClock.elapsedRealtime() - this.mRequestBirthTime;
   ...
   */
  public void setCacheEntry(final Cache.Entry entry) {
  ...
  /**
   * Returns a Map of parameters to be used for a POST or PUT request. Can throw {@link AuthFailureError} as authentication may be required to provide
   * these values.
   * <p>
   ...
   */
  private byte[] encodeParameters(final Map<String, String> params, final String paramsEncoding) {
   ...
   */
  public final void setShouldCache(final boolean shouldCache) {
   ...
   *          Error details
   */
  public void deliverError(final VolleyError error, final T cachedResponse) {

    if (this.mErrorListener != null) {
      this.mErrorListener.onErrorResponse(error, cachedResponse);
    }
  }
  ...
  public int compareTo(final Request<T> other) {
    ...
    final Priority left = this.getPriority();
    final Priority right = other.getPriority();
  ...
  public String toString() {
    ...
    final String trafficStatsTag = "0x" + Integer.toHexString(getTrafficStatsTag());
