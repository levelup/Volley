...
public class NetworkDispatcher extends Thread {
   ...
   */
  public NetworkDispatcher(final BlockingQueue<Request> queue, final Network network, final Cache cache, final ResponseDelivery delivery) {
  ...
  public void run() {
    ...
    while (true) {
      ...
      try {
        ...
        final NetworkResponse networkResponse = this.mNetwork.performRequest(request);
        ...
        final Response<?> response = request.parseNetworkResponse(networkResponse);
  ...
  private void parseAndDeliverNetworkError(final Request<?> request, VolleyError error) {
